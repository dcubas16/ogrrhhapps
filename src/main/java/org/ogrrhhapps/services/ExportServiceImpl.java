...
@Service
public class ExportServiceImpl implements ExporterService {
	...
	public void exportPdf(JasperPrint jp, ByteArrayOutputStream baos){
		...
		System.out.println("Entro aqui exportPdf");
		// Create a JRXlsExporter instance
		...
		try {
			System.out.println("Entro aqui exportPdf try");
			exporter.exportReport();
			
		} catch (JRException e) {
			System.out.println("Entro aqui exportPdf catch");
			throw new RuntimeException(e);
		}
	}
